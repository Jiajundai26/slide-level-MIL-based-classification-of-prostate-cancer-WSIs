#!/usr/bin/env python3
"""
TRIDENT-based Binary Classification Inference Script for TCGA-PRAD
...
def load_model(checkpoint_path: str, device: torch.device) -> Tuple[ABMIL, dict]:
    ...
    mode = config.get('mode', 'low_vs_high')
...
def generate_attention_heatmap(
    ...
    if output_path:
        if show_colorbar:
            ...
            # Set colorbar labels - attention shows model focus, not direct prediction
...
Examples:
    ...
    parser.add_argument('--labels_path', type=str, default=None,
                        help='Path to labels TSV for evaluation (optional)')
        ...
        if labels_path.exists():
            ...
            if len(df_eval) > 0:
                ...
                if mode == 'low_vs_high':
                    ...
                    df_eval['true_class'] = df_eval['label']
